// 예시
export const showExamppleContent = () => {
  return {
    modal_id: 1,
    header: `마일리지 기준`,
    content: `~~~`,
...
export const showMileageStandardContent = () => {
  return {
    ...
    content: `
            ...
            <div id="seed" class="mileage-standard__icon">
              <svg
          ...
          <div class="mileage-standard">
            <div id="sprout" class="mileage-standard__icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
          ...
          <div class="mileage-standard">
            <div id="leaf" class="mileage-standard__icon">
          ...
          <div class="mileage-standard">
            <div id="tree" class="mileage-standard__icon">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                height="24"
